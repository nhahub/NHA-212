    ...
    <div className="bg-gray-100 min-h-screen flex items-center justify-center p-4 font-inter">
      <div className="text-center bg-white rounded-lg shadow-xl p-8 max-w-md w-full">
        ...
        <div className="mb-6 flex justify-center items-center relative w-40 h-40 mx-auto">
          {/* Background circle */}
          <div className="absolute w-full h-full rounded-full bg-gray-200 opacity-50"></div>
          ...
          <div className="absolute w-full h-full rounded-full border-4 border-dashed border-orange-300"></div>
        ...
        <p className="text-gray-600 mb-6">
          It seems this page got lost in the kitchen. Let's get you back to the menu!
        </p>
